...
### 🛠 My knowledge
[![My Skills](https://skillicons.dev/icons?i=js,html,css,astro,nextjs,nodejs,c,cpp,cs,java,go,python,ts,rust,redis,supabase,uv,anaconda,aws,bash,vim,ai,ps,ae,ableton,arch,ubuntu,windows)](https://skillicons.dev)
### Socials
