...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,sass,astro,nextjs,nodejs,c,cpp,cs,java,go,python,ts,rust,fastapi,flask,sklearn,pytorch,redis,rabbitmq,prometheus,grafana,supabase,mongodb,sqlite,postgres,neovim,powershell,bun,anaconda,netlify,aws,docker,powershell,bash,vim,git,ai,ps,pr,ae,ableton,latex,obsidian,notion,kali,arch,ubuntu,windows)](https://skillicons.dev)
### Socials
